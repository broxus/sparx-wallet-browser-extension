export const StTychoVaultAbi = {
    ...
    functions: [
        ...
        { name: "removePendingWithdraw", inputs: [{ name: "_nonce", type: "uint64" }], outputs: [] },
        {
        ...
        { name: "processSendToUsers", inputs: [{ components: [{ name: "nonces", type: "uint64[]" }], name: "sendConfig", type: "map(address,tuple)" }], outputs: [] },
        {
            name: "withdrawToUser",
            inputs: [
                { name: "_amount", type: "uint128" },
        ...
        { name: "withdrawStEverFee", inputs: [{ name: "_amount", type: "uint128" }], outputs: [] },
        { name: "withdrawExtraEver", inputs: [], outputs: [] },
        {
            name: "upgrade",
            inputs: [
        ...
        { name: "onStrategyHandledDeposit", inputs: [], outputs: [] },
        { name: "onStrategyDidntHandleDeposit", inputs: [{ name: "_errcode", type: "uint32" }], outputs: [] },
        {
            name: "strategyReport",
            inputs: [
        ...
        { name: "onStrategyHandledWithdrawRequest", inputs: [], outputs: [] },
        {
        ...
        { name: "receiveFromStrategy", inputs: [], outputs: [] },
        { name: "receiveAdditionalTransferFromStrategy", inputs: [], outputs: [] },
        { name: "withdrawFromStrategyError", inputs: [{ name: "_errcode", type: "uint32" }], outputs: [] },
        { name: "processWithdrawExtraMoneyFromStrategies", inputs: [{ name: "_strategies", type: "address[]" }], outputs: [] },
        { name: "receiveExtraMoneyFromStrategy", inputs: [], outputs: [] },
        {
        ...
        { name: "_removeStrategy", inputs: [{ name: "_strategy", type: "address" }], outputs: [] },
        {
        ...
        { name: "isEmergencyProcess", inputs: [], outputs: [{ name: "value0", type: "bool" }] },
        { name: "startEmergencyProcess", inputs: [{ name: "_proofNonce", type: "uint64" }], outputs: [] },
        { name: "stopEmergencyProcess", inputs: [], outputs: [] },
        {
        ...
        { name: "emergencyWithdrawFromStrategiesProcess", inputs: [{ name: "_user", type: "address" }], outputs: [] },
        {
        ...
        { name: "changeEmergencyPauseState", inputs: [{ name: "_isPaused", type: "bool" }], outputs: [] },
        { name: "emergencyWithdrawToUser", inputs: [], outputs: [] },
        {
        ...
        { name: "receiveTokenWalletAddress", inputs: [{ name: "_wallet", type: "address" }], outputs: [] },
        { name: "setGainFee", inputs: [{ name: "_gainFee", type: "uint128" }], outputs: [] },
        { name: "setMinStrategyDepositValue", inputs: [{ name: "_minStrategyDepositValue", type: "uint128" }], outputs: [] },
        { name: "setMinStrategyWithdrawValue", inputs: [{ name: "_minStrategyWithdrawValue", type: "uint128" }], outputs: [] },
        { name: "setStEverFeePercent", inputs: [{ name: "_stEverFeePercent", type: "uint32" }], outputs: [] },
        { name: "setIsPaused", inputs: [{ name: "_isPaused", type: "bool" }], outputs: [] },
        { name: "setStrategyFactory", inputs: [{ name: "_strategyFactory", type: "address" }], outputs: [] },
        { name: "setWithdrawHoldTimeInSeconds", inputs: [{ name: "_holdTime", type: "uint64" }], outputs: [] },
        { name: "setFullUnlockRewardSeconds", inputs: [{ name: "_fullUnlockSeconds", type: "uint128" }], outputs: [] },
        { name: "setTimeAfterEmergencyCanBeActivated", inputs: [{ name: "_newTimeAfterEmergencyCanBeActivated", type: "uint64" }], outputs: [] },
        { name: "encodeDepositPayload", inputs: [{ name: "_nonce", type: "uint64" }], outputs: [{ name: "depositPayload", type: "cell" }] },
        {
        ...
        { name: "getDepositStEverAmount", inputs: [{ name: "_amount", type: "uint128" }], outputs: [{ name: "value0", type: "uint128" }] },
        { name: "getWithdrawEverAmount", inputs: [{ name: "_amount", type: "uint128" }], outputs: [{ name: "value0", type: "uint128" }] },
        {
        ...
        { name: "setNewAccountCode", inputs: [{ name: "_newAccountCode", type: "cell" }], outputs: [] },
        { name: "upgradeStEverAccount", inputs: [], outputs: [] },
        {
        ...
        { name: "setNewClusterCode", inputs: [{ name: "_newClusterCode", type: "cell" }], outputs: [] },
        { name: "upgradeStEverCluster", inputs: [{ name: "_clusterNonce", type: "uint32" }], outputs: [] },
        {
        ...
        { name: "nonce", inputs: [], outputs: [{ name: "nonce", type: "uint128" }] },
        {
            name: "strategies",
            inputs: [],
            outputs: [
    ...
    events: [
        { name: "PausedStateChanged", inputs: [{ name: "pauseState", type: "bool" }], outputs: [] },
        { name: "StrategyFactoryAddressUpdated", inputs: [{ name: "_strategyFactory", type: "address" }], outputs: [] },
        { name: "WithdrawHoldTimeUpdated", inputs: [{ name: "withdrawHoldTimeSeconds", type: "uint64" }], outputs: [] },
        { name: "FullUnlockTimeUpdated", inputs: [{ name: "fullUnlockTimeSeconds", type: "uint128" }], outputs: [] },
        { name: "TimeAfterEmergencyCanBeActivatedValueUpdated", inputs: [{ name: "timeAfterEmergencyCanBeActivated", type: "uint64" }], outputs: [] },
        { name: "StrategiesAdded", inputs: [{ name: "strategy", type: "address[]" }], outputs: [] },
        { name: "StrategyRemoved", inputs: [{ name: "strategy", type: "address" }], outputs: [] },
        { name: "StrategiesPendingRemove", inputs: [{ name: "strategies", type: "address[]" }], outputs: [] },
        {
        ...
        { name: "ClusterRemoving", inputs: [{ name: "cluster", type: "address" }], outputs: [] },
        {
            name: "ClusterRemoved",
            inputs: [
                { name: "cluster", type: "address" },
        ...
        { name: "SuccessWithdrawExtraEver", inputs: [{ name: "value", type: "uint128" }], outputs: [] },
        {
            name: "Deposit",
            inputs: [
        ...
        { name: "NewAccountCodeSet", inputs: [{ name: "newVersion", type: "uint32" }], outputs: [] },
        {
        ...
        { name: "NewClusterCodeSet", inputs: [{ name: "newVersion", type: "uint32" }], outputs: [] },
        {
        ...
        { name: "EmergencyProcessStarted", inputs: [{ name: "emitter", type: "address" }], outputs: [] },
        {
        ...
        { name: "EmergencyStatePaused", inputs: [], outputs: [] },
        { name: "EmergencyStateContinued", inputs: [], outputs: [] },
        { name: "EmergencyStopped", inputs: [], outputs: [] },
        { name: "WithdrawFee", inputs: [{ name: "amount", type: "uint128" }], outputs: [] },
    ],
    fields: [
